...
export class ArtificialHorizon {
  ...
  private readonly PITCH_SCALE = 1.8; // px per degree

  constructor() {
    this.group       = document.getElementById('horizon-group') as unknown as SVGGElement;
    this.pitchLadder = document.getElementById('pitch-ladder') as unknown as SVGGElement;
  ...
  update(euler: THREE.Euler): void {
    ...
    this.group.setAttribute(
      'transform',
      `rotate(${rollDeg}) translate(0, ${pitchOffset})`
    );
  }
}
