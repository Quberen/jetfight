...
export class EnemyAI {
    constructor(scene) {
        ...
        Object.defineProperty(this, "patrolAngle", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "evadeTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
    ...
    updateEnemy(e, dt, playerPos, playerFwd) {
        e.stateTimer -= dt;
        ...
        switch (e.state) {
            ...
            case 'attack':
                if (dist > e.attackRange * 1.5)
                    e.state = 'engage';
                if (e.hp / CombatParams.enemyHp < FLEE_HP)
                    e.state = 'flee';
                break;
            case 'evade':
                if (e.stateTimer <= 0)
    ...
    getLivingEnemies() { return this.enemies.filter(e => !e.isDead); }
}
